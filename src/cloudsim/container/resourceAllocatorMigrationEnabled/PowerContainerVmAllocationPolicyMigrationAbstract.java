...
import cloudsim.container.lists.PowerContainerVmList;
import cloudsim.container.resourceAllocators.PowerContainerVmAllocationAbstract;
...
public abstract class PowerContainerVmAllocationPolicyMigrationAbstract extends PowerContainerVmAllocationAbstract {
    ...
    public List<Map<String, Object>> optimizeAllocation(List<? extends ContainerVm> vmList) {
        ...
        HashSet<ContainerHost> excludedHost = new HashSet<ContainerHost>(overUtilizedHosts);
        List<Map<String, Object>> migrationMap = getNewVmPlacement(vmsToMigrate, excludedHost);
