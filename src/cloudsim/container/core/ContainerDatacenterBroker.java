...
import cloudsim.Log;
import cloudsim.UtilizationModelPlanetLabInMemory;
import cloudsim.container.lists.ContainerList;
import cloudsim.container.lists.ContainerVmList;
    ...
    protected void submitContainers() {
        ...
        for (Container container : getContainerList()) {
            ...
            if (cloudlet.getUtilizationModelCpu() instanceof UtilizationModelPlanetLabInMemory) {
                ...
                container.setWorkloadMips(cloudlet.getUtilizationModelCpu().getUtilization(CloudSim.clock()) * container.getMips());
                cloudlet.setContainerId(container.getId());
            }
            i++;
